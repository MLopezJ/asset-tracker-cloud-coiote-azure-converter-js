...
describe('convertListUsingSchema', () => {
	it(`should convert list using array type definition schema`, () => {
		...
		expect(convertListUsingSchema(object, schema)).toMatchObject(result)
	})
	...
	it(`should return undefined when a required value is not defined`, () => {
		...
		expect(convertListUsingSchema(object, schema)).toStrictEqual(result)
	})
})
